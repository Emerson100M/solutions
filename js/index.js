...
function OnCipherInputChange2() {
	const CipherInputField2 = document.getElementById("CipherInputField2").value;
	const CipherFunctionField = document.getElementById("CipherFunctionField").value - 1;
	if (CipherFunctionField == DECRYPT_DATA) {
		DecryptPasswordOnWorker(he.decode(CipherInputField2.trim()), "CipherResultField2");
		//_.unescape("$2QRTqKHqFz&lt;}*+cVC#oI,5~081XX~w5\\T*cPo5IY&amp;TO+q0_1;p!u.[&amp;AV$ki5$")
	}
	else {
		EncryptPasswordOnWorker(CipherInputField2, "CipherResultField2");
	}
}
